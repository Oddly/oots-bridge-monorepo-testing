...
--  *********************************************************************
--  Change Log: src/main/resources/db/releases/5.1/5.1-changelog.xml
--  Ran at: 11/16/23, 4:22 PM
--  Against: null@offline:mysql?changeLogFile=/Users/dragusa/work/cefgit/domibus-sql/domibus-msh-sql-scripts/target/liquibase/changelog-1.0.mysql
--  Liquibase version: 4.17.0
--  *********************************************************************

--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-7836::gautifr
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog-quartz.xml::EDELIVERY-3425::migueti
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-4740::idragusa
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-2427::Francois Gautier
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-7803-Dictionary Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-7803-UserMessage Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-7803-Miscellaneous Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-10221::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-7803-PMode Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-7803-Alert Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-8450::Francois Gautier
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-7803-Backend Filter Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-7803-User/Plugin User Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-4669::dussath
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-8503_1::ion perpegel
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-8532::ion perpegel
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-9563::Razvan Cretu
...
--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-9686::Lucian Furca
ALTER TABLE TB_PM_SECURITY ADD PROFILE VARCHAR(255) NULL;

--  Changeset src/main/resources/db/releases/5.1/5.1-changelog.xml::EDELIVERY-10091::Soumya Chandran 
