...
--  *********************************************************************
--  Change Log: src/main/resources/db/releases/5.1.9/5.1.9-changelog-multi-tenancy.xml
--  Ran at: 11/25/25, 7:15 PM
--  Against: null@offline:mysql?changeLogFile=target/liquibase/changelog-1.16-multi-tenancy.mysql
--  Liquibase version: 4.17.0
--  *********************************************************************

--  Changeset src/main/resources/db/releases/5.1.9/../../common/changelog-before-migration-statements.xml::EDELIVERY-12287_assert_previous_migration_succeeded-mysql::Gabriel Maier
DELIMITER //
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog-multi-tenancy.xml::EDELIVERY-7836::gautifr
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog-multi-tenancy.xml::EDELIVERY-7822,EDELIVERY-8050::Sebastian-Ion TINCU
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog-multi-tenancy.xml::1564496480476-13::Catalin Enache
--  create tables
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog-multi-tenancy.xml::EDELIVERY-9028-Audit Table for TB_USER_DOMAIN::Ion Perpegel
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog-multi-tenancy.xml::EDELIVERY-8688-General Schema Audit::Ion Perpegel
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog-multi-tenancy.xml::1564496480476-27::Catalin Enache
--  unique constraints
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog-multi-tenancy.xml::1564496480476-30::Catalin Enache
--  create indexes
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog-multi-tenancy.xml::1564496480476-56::Catalin Enache
--  create foreign keys
...
--  Changeset src/main/resources/db/releases/5.1.9/5.1.9-changelog-multi-tenancy.xml::EDELIVERY-9563::Razvan Cretu
